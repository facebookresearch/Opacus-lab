...
from GPT2.model.transformer import Transformer, TransformerLayer
from GPT2.model.attention import AttentionLayer
from GPT2.model.feedforward import PositionwiseFeedForward, Activation
...
def refactor_transformer(GPT2, size='S', use_low_rank=False, lm_head_rank=768,
    ...
    size_assertion_failure_str += '"M" (medium), "L" (large),  "XL" (extra large), '
